      ...
      <section className="py-12 bg-neutral-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-neutral-800 font-heading">Browse by Category</h2>
          </div>
          <div className="h-12 bg-neutral-200 animate-pulse rounded-lg mb-8"></div>
  ...
  return (
    <section className="py-12 bg-neutral-50">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-neutral-800 font-heading">Browse by Category</h2>
          <a href="/categories" className="text-[#0A3D62] hover:text-[#082C46] font-medium flex items-center">
            All Categories
        ...
        <Tabs defaultValue={activeCategory} onValueChange={setActiveCategory} className="w-full mb-8">
          <TabsList className="w-full justify-start overflow-x-auto p-1 bg-white border rounded-lg mb-6">
            {topCategories.map((category) => (
              ...
              >
                {category.name}
                <span className="ml-2 bg-neutral-100 text-neutral-700 text-xs px-2 py-1 rounded-full data-[state=active]:bg-[#082C46]">
                  {category.count || 0}
                </span>
              </TabsTrigger>
            ))}
